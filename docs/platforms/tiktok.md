# Platform Brief — TikTok

> **Platform:** TikTok (`TIKTOK`) · **Status:** deferred (slot siap) · **Brief versi:** `v0.0` · **Update:** —
>
...
- TikTok: comment, like, video; live monitoring diminta. Belum ada brief.
- Belum diaktifkan. Brief ditulis saat rollout R5.
- Kebijakan platform: `<...>`
